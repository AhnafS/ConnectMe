...
function ExampleStory() {
  ...
  var handleChangeFieldFilter = (0, _react.useCallback)(() => {
    setFieldFilterValue(fieldFilterSource);
    toast.push({
      status: 'success',
      title: "Updated field filter"
    });
  }, [fieldFilterSource]);
  ...
  }), isTypeTester && /*#__PURE__*/_react.default.createElement(_common.TypeTester, null), /*#__PURE__*/_react.default.createElement(_common.FormBuilderTester, {
